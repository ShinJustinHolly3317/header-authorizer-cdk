...
var require_package = __commonJS({
  "node_modules/sharp/package.json"(exports2, module2) {
    module2.exports = {
      ...
      _id: "sharp@0.30.7",
      _inBundle: false,
      _integrity: "sha512-G+MY2YW33jgflKPTXXptVO28HvNOo9G3j0MybYAHeEmby+QuD2U98dT6ueht9cv/XDqZspSpIhoSW+BAKJ7Hig==",
      _location: "/sharp",
      _phantomChildren: {
        "lru-cache": "6.0.0"
      },
      ...
      _resolved: "https://registry.npmjs.org/sharp/-/sharp-0.30.7.tgz",
      _shasum: "7862bda98804fdd1f0d5659c85e3324b90d94c7c",
      _spec: "sharp",
      _where: "/Users/justinkao/working/Onboard-practice/basic-auth-lambda",
      author: {
        name: "Lovell Fuller",
      ...
      contributors: [
        ...
        {
          name: "YvesBos",
          email: "yves_bos@outlook.com"
        },
        {
          name: "Guy Maliar",
          email: "guy@tailorbrands.com"
        },
        {
          name: "Nicolas Coden",
        ...
        },
        {
          ...
          email: "matthew+github@mceachen.org"
        },
        {
          name: "Jarda Kot\u011B\u0161ovec",
          email: "jarda.kotesovec@gmail.com"
        },
        {
          name: "Kenric D'Souza",
          email: "kenric.dsouza@gmail.com"
        },
        {
          name: "Oleh Aleinyk",
          email: "oleg.aleynik@gmail.com"
        },
        {
          name: "Marcel Bretschneider",
          email: "marcel.bretschneider@gmail.com"
        ...
        {
          name: "Nathan Graves",
          email: "nathanrgraves+github@gmail.com"
        },
        {
          name: "Tom Lokhorst",
        ...
        {
          name: "Alun Davies",
          email: "alun.owain.davies@googlemail.com"
        },
        {
          name: "Aidan Hoolachan",
          email: "ajhoolachan21@gmail.com"
        },
        {
          name: "Axel Eirola",
        ...
        {
          name: "Jordan Prudhomme",
          email: "jordan@raboland.fr"
        },
        {
          name: "Ilya Ovdin",
          email: "iovdin@gmail.com"
        },
        {
          name: "Andargor",
          email: "andargor@yahoo.com"
        },
        {
          name: "Paul Neave",
        ...
        },
        {
          ...
          email: "brenwken@gmail.com"
        },
        {
          name: "Brychan Bennett-Odlum",
          email: "git@brychan.io"
        },
        {
        ...
        {
          name: "Roman Malieiev",
          email: "aromaleev@gmail.com"
        },
        {
          name: "Tomas Szabo",
          email: "tomas.szabo@deftomat.com"
        },
        {
          name: "Robert O'Rourke",
          email: "robert@o-rourke.org"
        },
        {
          name: "Guillermo Alfonso Varela Chouci\xF1o",
          email: "guillevch@gmail.com"
        },
        {
          name: "Christian Flintrup",
          email: "chr@gigahost.dk"
        },
        {
          name: "Manan Jadhav",
          email: "manan@motionden.com"
        },
        {
          name: "Leon Radley",
        ...
        {
          name: "alza54",
          email: "alza54@thiocod.in"
        },
        {
          name: "Jacob Smith",
          email: "jacob@frende.me"
        },
        {
          name: "Michael Nutt",
          email: "michael@nutt.im"
        },
        {
          name: "Brad Parham",
        ...
        {
          name: "Chris Banks",
          email: "christopher.bradley.banks@gmail.com"
        },
        {
          name: "Ompal Singh",
          email: "ompal.hitm09@gmail.com"
        },
        {
          name: "Brodan"
        },
...
var require_input = __commonJS({
  "node_modules/sharp/lib/input.js"(exports2, module2) {
    ...
    function _inputOptionsFromObject(obj) {
      ...
      return [raw, density, limitInputPixels, unlimited, sequentialRead, failOn, failOnError, animated, page, pages, subifd].some(is.defined) ? { raw, density, limitInputPixels, unlimited, sequentialRead, failOn, failOnError, animated, page, pages, subifd } : void 0;
    }
  ...
  "node_modules/sharp/lib/operation.js"(exports2, module2) {
    ...
    function sharpen(options, flat, jagged) {
      if (!is.defined(options)) {
        ...
        if (is.number(options.sigma) && is.inRange(options.sigma, 0.01, 1e4)) {
          this.options.sharpenSigma = options.sigma;
        } else {
          throw is.invalidParameterError("options.sigma", "number between 0.01 and 10000", options.sigma);
        }
        if (is.defined(options.m1)) {
          if (is.number(options.m1) && is.inRange(options.m1, 0, 1e4)) {
        ...
        if (is.defined(options.m2)) {
          if (is.number(options.m2) && is.inRange(options.m2, 0, 1e4)) {
        ...
        if (is.defined(options.x1)) {
          if (is.number(options.x1) && is.inRange(options.x1, 0, 1e4)) {
        ...
        if (is.defined(options.y2)) {
          if (is.number(options.y2) && is.inRange(options.y2, 0, 1e4)) {
        ...
        if (is.defined(options.y3)) {
          if (is.number(options.y3) && is.inRange(options.y3, 0, 1e4)) {
...
var require_utility = __commonJS({
  "node_modules/sharp/lib/utility.js"(exports2, module2) {
    ...
    try {
      versions2 = require(`../vendor/${versions2.vips}/${platformAndArch}/versions.json`);
    } catch (_err) {
    }
    var vendor = {
    ...
    try {
      vendor.installed = fs.readdirSync(path.join(__dirname, `../vendor/${versions2.vips}`));
    } catch (_err) {
    }
